...
<div class="introduction">
    <h1>Acer</h1>
    <p>
        Acer是迅猛成长起来的中文算法学习社区。致力于帮助同学们从新手小白开始，
        用最短的时间、最平滑的学习曲线、最系统的学习方式成长为算法大佬。
        精心打造的算法系列课程-《Acer全家桶》行业内口碑领先，其中代表作品《算法基础课》的学员数量已突破1万人。品牌Slogan："学算法，就上Acer！"
    </p>

</div>
<div id="page2">
    <iframe align="center" width="100%" height="100%" src="bottom.html" frameborder="no" border="0" marginwidth="0"
